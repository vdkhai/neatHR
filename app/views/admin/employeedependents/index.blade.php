...
<table id="employeedependents" class="table table-striped table-hover">
	...
	<tr>
		...
		<th class="col-md-4">{{{ Lang::get('admin/employeedependents/table.employeedependent_title') }}}</th>
		<th class="col-md-6">{{{ Lang::get('admin/employeedependents/table.employeedependent_detail') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/employeedependents/' . $employee->id . '/create') }}");
			$('#modal').modal();
		});
	});
