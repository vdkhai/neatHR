...
<table id="organizationstructures" class="table table-striped table-hover">
	...
	<tr>
		...
		<th class="col-md-3">{{{ Lang::get('admin/organizationstructures/table.organizationstructure_address') }}}</th>
		<th class="col-md-1">{{{ Lang::get('admin/organizationstructures/table.organizationstructure_type') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/organizationstructures/create') }}");
			$('#modal').modal();
		});
	});
