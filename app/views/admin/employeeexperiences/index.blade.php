...
<table id="employeeexperiences" class="table table-striped table-hover">
	...
	<tr>
		...
		<th class="col-md-4">{{{ Lang::get('admin/employeeexperiences/table.employeeexperience_title') }}}</th>
		<th class="col-md-6">{{{ Lang::get('admin/employeeexperiences/table.employeeexperience_detail') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/employeeexperiences/' . $employee->id . '/create') }}");
			$('#modal').modal();
		});
	});
