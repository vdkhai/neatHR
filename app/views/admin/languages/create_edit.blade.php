...
@section('content')
	...
	<form class="form-horizontal" method="post" action="@if (isset($language)){{ URL::to('admin/languages/' . $language->id . '/edit') }}@endif" autocomplete="off">
		<!-- CSRF Token -->
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tab-general">
				...
				<div class="form-group {{{ $errors->has('description') ? 'error' : '' }}}">
					...
					<div class="col-md-10">
						<input class="form-control" type="text" name="description" id="description" value="{{{ Input::old('description', isset($language) ? $language->description : null) }}}" />
