...
@section('content')
	...
	<form class="form-horizontal" method="post" action="@if (isset($marriage)){{ URL::to('admin/marriages/' . $marriage->id . '/edit') }}@endif" autocomplete="off">
		<!-- CSRF Token -->
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tab-general">
				...
				<div class="form-group {{{ $errors->has('name') ? 'error' : '' }}}">
					<label class="col-md-2 control-label" for="name">Marriage Status Name</label>
					<div class="col-md-10">
