...
<table id="employmenttypes" class="table table-striped table-hover">
	<thead>
	<tr>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		oTable = $('#employmenttypes').dataTable( {
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "{{ URL::to('admin/employmenttypes/data') }}",
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/employmenttypes/create') }}");
			$('#modal').modal();
		});
	});
