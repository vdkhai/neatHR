...
<table id="states" class="table table-striped table-hover">
	...
	<tr>
		...
		<th class="col-md-4">{{{ Lang::get('admin/states/table.country_name') }}}</th>
		<th class="col-md-4">{{{ Lang::get('admin/states/table.state_name') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/states/create') }}");
			$('#modal').modal();
		});
	});
