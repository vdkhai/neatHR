...
<table id="employeecertifications" class="table table-striped table-hover">
	...
	<tr>
		...
		<th class="col-md-4">{{{ Lang::get('admin/employeecertifications/table.employeecertification_title') }}}</th>
		<th class="col-md-6">{{{ Lang::get('admin/employeecertifications/table.employeecertification_detail') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/employeecertifications/' . $employee->id . '/create') }}");
			$('#modal').modal();
		});
	});
