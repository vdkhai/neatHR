...
@section('content')
	...
	<form class="form-horizontal" method="post" action="@if (isset($education)){{ URL::to('admin/educations/' . $education->id . '/edit') }}@endif" autocomplete="off">
		<!-- CSRF Token -->
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tab-general">
				...
				<div class="form-group {{{ $errors->has('short_name') ? 'error' : '' }}}">
					<label class="col-md-2 control-label" for="name">Short University Name</label>
					<div class="col-md-10">
				...
				<div class="form-group {{{ $errors->has('name') ? 'error' : '' }}}">
					<label class="col-md-2 control-label" for="name">University Name</label>
					<div class="col-md-10">
				...
				<div class="form-group {{{ $errors->has('published') || $errors->has('published') ? 'error' : '' }}}">
					<label class="col-md-2 control-label" for="confirm">Status</label>
					<div class="col-md-6">
						@if ($mode == 'create')
