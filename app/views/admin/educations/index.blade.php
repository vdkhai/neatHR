...
<table id="educations" class="table table-striped table-hover">
	...
	<tr>
		...
		<th class="col-md-4">{{{ Lang::get('admin/educations/table.education_short_name') }}}</th>
		<th class="col-md-6">{{{ Lang::get('admin/educations/table.education_name') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/educations/create') }}");
			$('#modal').modal();
		});
	});
