...
<table id="currencies" class="table table-striped table-hover">
	...
	<tr>
		...
		<th class="col-md-1">{{{ Lang::get('admin/currencies/table.currency_code') }}}</th>
		...
		<th class="col-md-3">{{{ Lang::get('table.desc') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/currencies/create') }}");
			$('#modal').modal();
		});
	});
