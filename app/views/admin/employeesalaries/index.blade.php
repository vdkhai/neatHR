...
<table id="employeesalaries" class="table table-striped table-hover">
	...
	<tr>
		...
		<th class="col-md-4">{{{ Lang::get('admin/employeesalaries/table.employeesalary_title') }}}</th>
		<th class="col-md-6">{{{ Lang::get('admin/employeesalaries/table.employeesalary_detail') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/employeesalaries/' . $employee->id . '/create') }}");
			$('#modal').modal();
		});
	});
