...
@section('content')
	...
	<form class="form-horizontal" method="post" action="@if (isset($skill)){{ URL::to('admin/skills/' . $skill->id . '/edit') }}@endif" autocomplete="off">
		<!-- CSRF Token -->
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tab-general">
				...
				<div class="form-group {{{ $errors->has('name') ? 'error' : '' }}}">
					<label class="col-md-2 control-label" for="name">Skill Name</label>
					<div class="col-md-10">
				...
				<div class="form-group {{{ $errors->has('description') ? 'error' : '' }}}">
					<label class="col-md-2 control-label" for="description">Description Skill Name</label>
					<div class="col-md-10">
						<input class="form-control" type="text" name="description" id="description" value="{{{ Input::old('description', isset($skill) ? $skill->description : null) }}}" />
