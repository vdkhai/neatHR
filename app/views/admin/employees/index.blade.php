...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			...
			<a data-toggle="modal" data-target="#modal" id="import" href="#" class="btn btn-small btn-info"><span class="glyphicon glyphicon-import"></span> Import</a>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/employees/create') }}");
			$('#modal').modal();
		});

		$('#import').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/employees/import') }}");
			$('#modal').modal();
		});
	});
