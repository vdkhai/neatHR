...
<table id="recruitcandidates" class="table table-striped table-hover">
	<thead>
	<tr>
		<th class="col-md-3">{{{ Lang::get('admin/recruitcandidates/table.recruitcandidate_vacancy') }}}</th>
		<th class="col-md-3">{{{ Lang::get('admin/recruitcandidates/table.recruitcandidate_name') }}}</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#create').click(function(e){
			e.preventDefault();
			getAjaxContent("{{ URL::to('admin/recruitcandidates/create') }}");
			$('#modal').modal();
		});
	});
